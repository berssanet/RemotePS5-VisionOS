---
skill: monotonic-clock
status: enforced
severity: high
applies_to:
  - VisionRemotePS5/Services/StreamingService.swift
  - VisionRemotePS5/Streaming/VideoDecoder.swift
  - VisionRemotePS5/Streaming/UpscalingPipeline.swift
  - VisionRemotePS5/Streaming/AudioVideoSyncController.swift
  - VisionRemotePS5/Streaming/LowLatencyAudioPlayer.swift
  - any new Swift code computing time deltas in the streaming pipeline
evidence:
  - VisionRemotePS5/Services/StreamingService.swift:12      # `import QuartzCore  // v10.1: For CACurrentMediaTime monotonic clock`
  - VisionRemotePS5/Services/StreamingService.swift:337,347,390  # CACurrentMediaTime() usage
  - TODO.md:30-35   # Phase 1.2 — Monotonic Clock fix
---

# Skill: Monotonic Clock — `CACurrentMediaTime()` ONLY
